...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/doctors/details/**").access("hasAnyRole('ROLE_ADMIN', 'ROLE_BACSI', 'ROLE_NHANVIEN')")
                .antMatchers("/doctors/**").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/employees").access("hasAnyRole('ROLE_ADMIN', 'ROLE_BACSI', 'ROLE_NHANVIEN')")
                .antMatchers("/employees/details/**").access("hasAnyRole('ROLE_ADMIN', 'ROLE_BACSI', 'ROLE_NHANVIEN')")
