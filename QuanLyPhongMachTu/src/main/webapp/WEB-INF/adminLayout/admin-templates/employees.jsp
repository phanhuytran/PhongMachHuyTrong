                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                ...
                                <address>
                                    ...
                                    <a href="/employees/detail/${d.id}"><i class="far fa-address-card"></i></a>
                                    <sec:authorize access="hasAnyRole('ROLE_ADMIN')">
                                        <a style="padding-left: 5%" href="/employees/edit/${d.id}"><i
                                                class="far fa-edit"></i></a>
                                        <a style="padding-left: 5%" href="javascript:;"
                                           onclick="xoaNhanVien('${d.id}')"><i class="far fa-trash-alt"></i></a>
                                    </sec:authorize>
                                </address>
                                </p>
                            </div>
