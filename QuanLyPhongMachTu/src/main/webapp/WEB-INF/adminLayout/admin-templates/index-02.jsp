        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="user-pro">
                <a href="#" class="waves-effect">
                    <img src="<c:url value="/admin-resources/plugins/images/users/d1.jpg"/>" alt="user-img" class="img-circle"> <span class="hide-menu">${pageContext.request.userPrincipal.name} <span style="margin-top: 2px" class="fas fa-chevron-right"></span></span>
                </a>
            ...
            <li><a href="/admin" class="waves-effect"><i class="fas fa-tachometer-alt" style="margin-right: 20px"></i> <span class="hide-menu">Bảng điều khiển</span></a></li>
            <li><a href="javascript:void(0);" class="waves-effect"><i class="far fa-envelope" style="margin-right: 20px"></i> <span class="hide-menu"> Mailbox <span style="float: right; margin-top: 3px" class="fas fa-chevron-right"></span><span class="label label-rouded label-danger pull-right" style="margin-right: 10px">6</span></span></a>
                <ul class="nav nav-second-level">
            ...
            <li><a href="javascript:void(0);" class="waves-effect"><i class="fas fa-calendar" style="margin-right: 20px"></i> <span class="hide-menu"> Cuộc hẹn <span style="float: right; margin-top: 3px" class="fas fa-chevron-right"></span></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="/doctor-schedule">Lịch hẹn Bác sĩ</a></li>
                    <li><a href="/book-appointment">Đặt lịch khám</a></li>
                </ul>
            </li>
            <li><a href="javascript:void(0);" class="waves-effect"><i class="fas fa-user-md" style="margin-right: 20px"></i> <span class="hide-menu"> Bác sĩ <span style="float: right; margin-top: 3px" class="fas fa-chevron-right"></span></span></a>
                <ul class="nav nav-second-level">
            ...
            <li><a href="javascript:void(0);" class="waves-effect"><i class="fas fa-user" style="margin-right: 20px"></i> <span class="hide-menu"> Nhân viên <span style="float: right; margin-top: 3px" class="fas fa-chevron-right"></span></span></a>
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="/employees/edit-employee">Cập nhật nhân viên</a></li>
                    <li><a href="/employees/employee-profile">Thông tin nhân viên</a></li>
                </ul>
            </li>
            ...
            <li><a href="javascript:void(0);" class="waves-effect"><i class="fas fa-credit-card" style="margin-right: 20px"></i> <span class="hide-menu"> Thanh toán <span style="float: right; margin-top: 3px" class="fas fa-chevron-right"></span></span></a>
                <ul class="nav nav-second-level">
