        ...
        <div class="container-fluid">
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    ...
                    <a href="/employees/edit/${Employee.id}" target="_blank" class="btn btn-primary pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light"> Sữa thông tin</a>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="white-box">
                        <div class="row">
                            <div class="col-md-3 col-xs-6 b-r"> <strong>Họ và Tên</strong>
                                <br>
                                <p class="text-muted">${Employee.ho} ${Employee.ten}</p>
                            </div>
                            <div class="col-md-3 col-xs-6 b-r"> <strong>Giới tính</strong>
                                <br>
                                <p class="text-muted">
                                    <c:if test="${Employee.gioiTinh == 'Nam'}">Nam</c:if>
                                    <c:if test="${Employee.gioiTinh == 'Nu'}">Nữ</c:if>
                                </p>
                            </div>
                            <div class="col-md-3 col-xs-6 b-r"> <strong>Ngày sinh</strong>
                                <br>
                                <p class="text-muted">${Employee.ngaySinh}</p>
                            </div>
                            <div class="col-md-3 col-xs-6"> <strong>Chi tiết nhân viên</strong>
                                <br>
                                <p class="text-muted"> Tốt nghiệp đại học</p>
                            </div>
                        </div>
                        <hr>
                        ...
                        <h4 class="m-t-30">Báo cáo công việc</h4>
                        <hr>
                        <h5>a <span class="pull-right">80</span></h5>
                        <div class="progress">
                            <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width:80%;"> <span class="sr-only">50% Complete</span> </div>
                        </div>
                        <h5>c<span class="pull-right">90</span></h5>
                        <div class="progress">
                        ...
                        <h5>d<span class="pull-right">50</span></h5>
                        <div class="progress">
                        ...
                        <h5>d<span class="pull-right">70%</span></h5>
                        <div class="progress">
