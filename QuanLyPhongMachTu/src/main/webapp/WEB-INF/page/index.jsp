    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <div class="wow fadeInUp" data-wow-delay="0.2s">
                    <img src="<c:url value="/resources/img/dummy/img-1.jpg"/>" class="img-responsive" alt=""/>
                </div>
            </div>
            <div class="col-sm-3 col-md-3">
                <div class="wow fadeInRight" data-wow-delay="0.1s">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="wow fadeInDown" data-wow-delay="0.1s">
                    <div class="section-heading text-center">
                        <h2 class="h-bold">Đội ngủ Bác sĩ</h2>
                        <p>Cung cấp chất lượng chăm sóc sức khỏe tốt nhất cho bạn</p>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                ...
                <div id="filters-container" class="cbp-l-filters-alignLeft">
                    ...
                    <div data-filter=".cardiologist" class="cbp-filter-item">
                        Bác sĩ tim mạch (<div class="cbp-filter-counter"></div>)
                    </div>
                    <div data-filter=".psychiatrist" class="cbp-filter-item">
                        Bác sĩ tâm lý (<div class="cbp-filter-counter"></div>)
                    </div>
                    <div data-filter=".neurologist" class="cbp-filter-item">
                        Nhà thần kinh học (<div class="cbp-filter-counter"></div>)
                    </div>
                </div>
                    ...
                    <ul>
                        <li class="cbp-item psychiatrist">
                            <a href="resources/doctors/member1.html" class="cbp-caption cbp-singlePage">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="<c:url value="/resources/img/team/1.jpg"/>" alt="" width="100%">
                                </div>
                            ...
                            <div class="cbp-l-grid-team-position">Bác sĩ tâm lý</div>
                        </li>
                        <li class="cbp-item cardiologist">
                            <a href="resources/doctors/member2.html" class="cbp-caption cbp-singlePage">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="<c:url value="/resources/img/team/2.jpg"/>" alt="" width="100%">
                                </div>
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-l-grid-team-position">Bác sĩ tim mạch</div>
                        </li>
                        <li class="cbp-item cardiologist">
                            <a href="resources/doctors/member3.html" class="cbp-caption cbp-singlePage">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="<c:url value="/resources/img/team/3.jpg"/>" alt="" width="100%">
                                </div>
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                        ...
                        <li class="cbp-item neurologist">
                            <a href="resources/doctors/member4.html" class="cbp-caption cbp-singlePage">
                                <div class="cbp-caption-defaultWrap">
                                    <img src="<c:url value="/resources/img/team/4.jpg"/>" alt="" width="100%">
                                </div>
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-l-grid-team-position">Nhà thần kinh học</div>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="wow bounceInUp" data-wow-delay="0.2s">
                    <div id="owl-works" class="owl-carousel">
                        <div class="item">
                            <a href="<c:url value="/resources/img/photo/1.jpg"/>" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/1@2x.jpg">
                                <img src="<c:url value="/resources/img/photo/1.jpg"/>" class="img-responsive" alt="img">
                            </a>
                        </div>
                        <div class="item">
                            <a href="<c:url value="/resources/img/photo/2.jpg"/>" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/2@2x.jpg">
                                <img src="<c:url value="/resources/img/photo/2.jpg"/>" class="img-responsive " alt="img">
                            </a>
                        </div>
                        <div class="item">
                            <a href="<c:url value="/resources/img/photo/3.jpg"/>" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/3@2x.jpg">
                                <img src="<c:url value="/resources/img/photo/3.jpg"/>" class="img-responsive " alt="img">
                            </a>
                        </div>
                        <div class="item">
                            <a href="<c:url value="/resources/img/photo/4.jpg"/>" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/4@2x.jpg">
                                <img src="<c:url value="/resources/img/photo/4.jpg"/>" class="img-responsive " alt="img">
                            </a>
                        </div>
                        <div class="item">
                            <a href="<c:url value="/resources/img/photo/5.jpg"/>" title="This is an image title"data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/5@2x.jpg">
                                <img src="<c:url value="/resources/img/photo/5.jpg"/>" class="img-responsive " alt="img">
                            </a>
                        </div>
                        <div class="item">
                            <a href="<c:url value="/resources/img/photo/6.jpg"/>" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/6@2x.jpg">
                                <img src="<c:url value="/resources/img/photo/6.jpg"/>" class="img-responsive " alt="img">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="<c:url value="/resources/img/testimonials/3.jpg"/>" alt="" class="person img-circle"/>
                        ...
                        <div class="item">
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="<c:url value="/resources/img/testimonials/4.jpg"/>" alt="" class="person img-circle"/>
                            ...
                            <div class="col-md-4 col-sm-6 hidden-xs">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="<c:url value="/resources/img/testimonials/5.jpg"/>" alt="" class="person img-circle"/>
                            ...
                            <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="<c:url value="/resources/img/testimonials/6.jpg"/>" alt="" class="person img-circle"/>
