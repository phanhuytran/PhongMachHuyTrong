        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Thêm hóa đơn thanh toán</h4>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control">
                                        ...
                                        <option>Thẻ bảo hiểm</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-12">Tình trạng thanh toán</label>
                                <div class="col-sm-12">
                                    <select class="form-control">
                                        <option>Lựa chọn tình trạng thanh toán</option>
